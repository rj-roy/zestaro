    ...
    return (
        <div className="mx-auto grid max-w-full grid-cols-1 gap-3">
            <div className="min-w-0 min-h-screen bg-wh-p dark:bg-bl-p gap-3 px-4 sm:px-6 lg:px-2 py-8">
                <div className="flex flex-col lg:flex-row items-center lg:justify-between mx-3 p-3 gap-4 mb-5">
                    <div className="space-y-2 text-center lg:text-left">
                        <h1 className="text-3xl font-serif font-bold text-secondary dark:text-tertiary">
                            Your Cart
                        </h1>
                        <p className="text-neutral dark:text-neutral/80 text-xs">
