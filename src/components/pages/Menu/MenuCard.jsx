...
export default function MenuCard({ item }) {
  ...
  return (
    <div className="group bg-white dark:bg-neutral/20 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-neutral/10">
      {/* Image */}
